...
const fleet = [
  {
    ...
    sail_area: '10 м²',
    crew: '2–4 чел.',
    note: 'Разборный, для походов и соревнований до 10 м²',
    sort_order: 1,
  },
  {
    name: '«Бриз-Микро»',
    ...
    sail_area: '5 м²',
    crew: '1–2 чел.',
    note: 'Самый безопасный для новичков — мачта гнётся, парус сбрасывает порыв',
    sort_order: 2,
  },
  {
    name: '«Витамин»',
    ...
    sail_area: '—',
    crew: '1–2 чел.',
    note: 'Сибирский проект. Для уверенных рулевых',
    sort_order: 3,
  },
  {
    name: 'Плот «Дункель»',
